class LeagueLoader
  # Loads all of the information about a given league and creates the teams for it. 
  ...
  def initialize(league, user)
    ...
    AddPositionRankings.new(league).run! unless league.league_stats.where(position_ranking: 0).count == 0
  end
